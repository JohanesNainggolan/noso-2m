...
#define DEFAULT_POOL_URL_LIST "nosopool;f04ever;devnoso"
#define DEFAULT_MINER_ADDRESS "N3pTbcVDfunqQYgxq8Y41w3QgioJ3FH"
...
int main( int argc, char *argv[] ) {
    ...
    #endif
    cxxopts::Options options( "Mine", "Pribadi" );
    options.add_options()
